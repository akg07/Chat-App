...
if (process.env.NODE_ENV === "production") {
  app.use(express.static(path.join(__dirname1, "/Chat-app-ui/build")));
  app.get("*", (req, res) => {
    res.sendFile(
      path.resolve(__dirname1, "Chat-app-ui", "build", "index.html")
    );
  });
} else {
  app.get("/", (req, res) => {
...
const io = require("socket.io")(server, {
  ...
  cors: {
    ...
    origin: "https://chat-application-ympr.onrender.com/",
  },
});
